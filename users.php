...
$result = $Obj->httpGet(ADMIN_URL.'api/admin/users/status/'.$_GET['user_type']);
						...
						<table class="display datatables-basic">
							...
							<tbody>
								...
								<tr>
									...
									<td>
										<a class="" href="edit-user.php?id=<?php echo $Obj->encrypt($user_value->user_id); ?>&user_type=<?php echo $user_value->user_type; ?>">Edit</a>
										&nbsp;&nbsp;&nbsp;	
