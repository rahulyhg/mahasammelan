							...
							<div class="form-body">
								...
								<div class="form-group">
									...
									<div class="col-md-5">
										<div class="inputer">
											<div class="input-wrapper">
												<input type="text" name="tirth_name" class="form-control" value="<?php echo $place_result->place_array->name; ?>"  required>
											</div>
										</div>
									</div>
									</div>
									...
									<div class="col-md-5">
										<div class="inputer">
											<div class="input-wrapper">
												<input type="text" name="tirth_name_hindi" class="form-control" value="<?php echo $place_result->place_array->name_hindi; ?>"  required>
											</div>
										</div>
									</div>
									</div>
								...
								<div class="form-group">
									...
									<div class="col-md-5">
										<div class="inputer">
											<div class="input-wrapper">
												<textarea name="tirth_address" class="form-control" required><?php echo $place_result->place_array->address; ?></textarea>
											</div>
										</div>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-md-5">
										<div class="inputer">
											<div class="input-wrapper">
												<textarea name="tirth_address_hindi" class="form-control" required><?php echo $place_result->place_array->address_hindi; ?></textarea>
											</div>
										</div>
									</div>
								</div>
