...
$result = $Obj->httpGet(BASE_URL.'api/admin/pages/all');

$page_result  = json_decode($result);
							...
							<tbody>
								...
								<?php
									...
									if(!empty($page_result->success)){
										...
										foreach($page_result->page_array as $page_value){
								...
								<tr>
									...
									<td>
										...
										<a class="" href="edit-page.php?page_slug=<?php echo $page_value->page_slug; ?>">Edit</a>
