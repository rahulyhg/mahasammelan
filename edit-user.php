...
if(isset($_POST['add_note_submit']) && !empty($_POST['add_note_submit'])){
    ...
    $postfields = array('user_id'=>$_POST['user_id'],'sadhu_name_hindi'=>trim($_POST['sadhu_name_hindi']),
								...
								'father_name_hindi'=>$_POST['father_name_hindi'],
								 ...
								 'mother_name_eng'=>$_POST['mother_name_eng'] ,
								   ...
								   'degree_eng'=>trim($_POST['degree_eng']),
	...
	$result = $Obj->httpPost(ADMIN_URL.'api/user/edit/diksha/form',$postfields);
	             
	              $Obj->Redirect("users.php?user_type=$user_type");
...
$result_diksha = $Obj->httpGet(ADMIN_URL.'api/user/Info/singlget/dikshaform/'.$user_id);

$diksh_result = json_decode($result_diksha);
		...
		<div class="row">
			...
			<div class="col-md-12">
				...
				<div class="panel">
					...
					<div class="panel-heading">
						...
						<ul class="nav nav-tabs with-panel">
							...
							<li class="active"><a href="#panel-tab1" data-toggle="tab" class="btn-ripple">Edit User</a></li>
				...
				{?>
					...
					<?php }?>
									<form action="#" class="parsley-validate" method="post" id="user_edit_from"enctype="multipart/form-data">

									<input type="hidden" name="user_id" value="<?php echo $user_id; ?>"/>
                                  <input type="hidden" name="old_image"  class="form-control" value="<?php echo $user_result->user_array->image ?>" />
            ...
            <input type="text" style="width: 200px" name="diksha_date" class="form-control bootstrap-daterangepicker-basic" value="<?php echo date('m/d/Y',strtotime($user_result->user_array->diksha_date)); ?>" readonly />
				...
				<input type="text" name="username" value="<?php echo $user_result->user_array->username; ?>" class="form-control" required>
                                      ...
                                      <div class="col-md-6">
												...
												<div class="form-group">
													...
													<label class="control-label">Username (Hindi)</label>
				...
				<input type="text" name="username_hindi" value="<?php echo $user_result->user_array->username_hindi; ?>" class="form-control" required>
												...
												<div class="form-group">
													...
													<div class="inputer">
														...
														<div class="input-wrapper">
															...
															<input type="email" name="" value="<?php echo $user_result->user_array->email_address; ?>" class="form-control"  readonly="">
												...
												<div class="form-group">
													...
													<div class="inputer">
														...
														<div class="input-wrapper">
															...
															<input type="number" name="mobile_number" value="<?php echo $user_result->user_array->mobile_number; ?>" class="form-control" required>
										...
										<div class="col-md-6">
                                             ...
                                             <img src="<?php echo ADMIN_URL.'uploads/' .$user_result->user_array->image; ?>"  width = "150px" height = "150px"readonly />
										...
										<div class="row">
												...
												<div class="form-group">
													...
													<label class="control-label">User Type</label>
														...
														<select name="user_type" class="selecter form-control" >

															<option value="">-Select-</option>

															<option value="Sadhu" <?php if($user_result->user_array->user_type == 'Sadhu') { ?>selected="selected"<?php } ?>>Sadhu</option>

															<option value="Sadhvi" <?php if($user_result->user_array->user_type == 'Sadhvi') { ?>selected="selected"<?php } ?>>Sadhvi</option>
												...
												<div class="form-group">
													...
													<label class="control-label">Group Name</label>
														...
														<select name="group_id" class="selecter form-control">
															<option value="">-Select-</option>
															<?php
																if(!empty($group_result->success)){
																	foreach($group_result->group_array as $group_value){
															?>
																	<option value="<?php echo $group_value->id; ?>" <?php if($user_result->user_array->group_id == $group_value->id){ ?>selected <?php } ?>><?php echo $group_value->group_name.' ('.$group_value->group_head.')'; ?></option>
															<?php
																	}
																}
															?>
												...
												<div class="form-group">
													...
													<div class="inputer">
														...
														<div class="input-wrapper">
															...
															<input type="text" style="width: 200px" name="sadhu_name_hindi" class="form-control " value="<?php echo ($diksh_result->stavan_array->sadhu_name_hindi); ?>"  />
												...
												<div class="form-group">
													...
													<div class="inputer">
														...
														<div class="input-wrapper">
															...
															<input type="text" style="width: 200px" name="sadhu_name_eng" class="form-control " value="<?php echo ($diksh_result->stavan_array->sadhu_name_eng); ?>" />
							...
							<input type="text" style="width: 200px" name="diksha_parada_hindi" class="form-control " value="<?php echo $diksh_result->stavan_array->diksha_parada_hindi; ?>"  />
												...
												<div class="form-group">
													...
													<div class="inputer">
														...
														<div class="input-wrapper">
															...
															<input type="text" style="width: 200px" name="diksha_parada_eng" class="form-control " value="<?php echo ($diksh_result->stavan_array->diksha_parada_eng); ?>"  />
												...
												<div class="form-group">
													...
													<div class="inputer">
														...
														<div class="input-wrapper">
															...
															<input type="text" style="width: 200px" name="guru_hindi" class="form-control " value="<?php echo ($diksh_result->stavan_array->guru_hindi); ?>" />
												...
												<div class="form-group">
													...
													<div class="inputer">
														...
														<div class="input-wrapper">
															...
															<input type="text" style="width: 200px" name="guru_eng" class="form-control " value="<?php echo ($diksh_result->stavan_array->guru_eng); ?>"  />
												...
												<div class="form-group">
													...
													<div class="inputer">
														...
														<div class="input-wrapper">
															...
															<input type="text" style="width: 200px" name="sadhu_mandal_hindi" class="form-control " value="<?php echo ($diksh_result->stavan_array->sadhu_mandal_hindi); ?>" />
												...
												<div class="form-group">
													...
													<div class="inputer">
														...
														<div class="input-wrapper">
															...
															<input type="text" style="width: 200px" name="sadhu_mandal_eng" class="form-control " value="<?php echo ($diksh_result->stavan_array->sadhu_mandal_eng); ?>"  />
												...
												<div class="form-group">
													...
													<div class="inputer">
														...
														<div class="input-wrapper">
															...
															<input type="text" style="width: 200px" name="diksha_date" class="form-control bootstrap-daterangepicker-basic" value="<?php echo date('m/d/Y',strtotime($diksh_result->stavan_array->diksha_date)); ?>" readonly />
												...
												<div class="form-group">
													...
													<div class="inputer">
														...
														<div class="input-wrapper">
															...
															<input type="text" style="width: 200px" name="dikhsa_place_hindi" class="form-control " value="<?php echo($diksh_result->stavan_array->dikhsa_place_hindi); ?>" />
												...
												<div class="form-group">
													...
													<div class="inputer">
														...
														<div class="input-wrapper">
															...
															<input type="text" style="width: 200px" name="dikhsa_place_eng" class="form-control " value="<?php echo ($diksh_result->stavan_array->dikhsa_place_eng); ?>" />
												...
												<div class="form-group">
													...
													<div class="inputer">
														...
														<div class="input-wrapper">
															...
															<input type="text" style="width: 200px" name="badi_diksha_pradata_hindi" class="form-control " value="<?php echo ($diksh_result->stavan_array->badi_diksha_pradata_hindi); ?>"  />
												...
												<div class="form-group">
													...
													<div class="inputer">
														...
														<div class="input-wrapper">
															...
															<input type="text" style="width: 200px" name="badi_diksha_pradata_eng" class="form-control " value="<?php echo ($diksh_result->stavan_array->badi_diksha_pradata_eng); ?>"  />
												...
												<div class="form-group">
													...
													<div class="inputer">
														...
														<div class="input-wrapper">
															...
															<input type="text" style="width: 200px" name="dikhha_date" class="form-control bootstrap-daterangepicker-basic" value="<?php echo date('m/d/Y',strtotime($diksh_result->stavan_array->dikhha_date)); ?>" readonly />
												...
												<div class="form-group">
													...
													<div class="inputer">
														...
														<div class="input-wrapper">
															...
															<input type="text" style="width: 200px" name="badi_diksha_place_hindi" class="form-control " value="<?php echo ($diksh_result->stavan_array->badi_diksha_place_hindi); ?>" />
												...
												<div class="form-group">
													...
													<div class="inputer">
														...
														<div class="input-wrapper">
															...
															<input type="text" style="width: 200px" name="badi_diksha_place_eng" class="form-control" value="<?php echo ($diksh_result->stavan_array->badi_diksha_place_eng); ?>"   />
												...
												<div class="form-group">
													...
													<div class="inputer">
														...
														<div class="input-wrapper">
															...
															<input type="text" style="width: 200px" name="sadhu_person_first_hindi" class="form-control " value="<?php echo($diksh_result->stavan1->sadhu_person_first_hindi); ?>"  />
												...
												<div class="form-group">
													...
													<div class="inputer">
														...
														<div class="input-wrapper">
															...
															<input type="text" style="width: 200px" name="sadhu_person_first_eng" class="form-control " value="<?php echo($diksh_result->stavan1->sadhu_person_first_eng); ?>"  />
												...
												<div class="form-group">
													...
													<div class="inputer">
														...
														<div class="input-wrapper">
															...
															<input type="text" style="width: 200px" name="relation_first_hindi" class="form-control " value="<?php echo($diksh_result->stavan1->relation_first_hindi); ?>" />
												...
												<div class="form-group">
													...
													<div class="inputer">
														...
														<div class="input-wrapper">
															...
															<input type="text" style="width: 200px" name="relation_first_eng" class="form-control " value="<?php echo($diksh_result->stavan1->relation_first_eng); ?>" />
												...
												<div class="form-group">
													...
													<div class="inputer">
														...
														<div class="input-wrapper">
															...
															<input type="text" style="width: 200px" name="sadhu_person_secondt_hindi" class="form-control " value="<?php echo($diksh_result->stavan1->sadhu_person_secondt_hindi); ?>" />
												...
												<div class="form-group">
													...
													<div class="inputer">
														...
														<div class="input-wrapper">
															...
															<input type="text" style="width: 200px" name="sadhu_person_secondt_eng" class="form-control " value="<?php echo($diksh_result->stavan1->sadhu_person_secondt_eng); ?>"  />
												...
												<div class="form-group">
													...
													<div class="inputer">
														...
														<div class="input-wrapper">
															...
															<input type="text" style="width: 200px" name="relation_second_hindi" class="form-control " value="<?php echo($diksh_result->stavan1->relation_second_hindi); ?>"  />
												...
												<div class="form-group">
													...
													<div class="inputer">
														...
														<div class="input-wrapper">
															...
															<input type="text" style="width: 200px" name="relation_second_eng" class="form-control " value="<?php echo($diksh_result->stavan1->relation_second_eng); ?>" />
												...
												<div class="form-group">
													...
													<div class="inputer">
														...
														<div class="input-wrapper">
															...
															<input type="text" style="width: 200px" name="sadhu_person_third_hind" class="form-control " value="<?php echo($diksh_result->stavan1->sadhu_person_third_hind); ?>" />
												...
												<div class="form-group">
													...
													<div class="inputer">
														...
														<div class="input-wrapper">
															...
															<input type="text" style="width: 200px" name="sadhu_person_third_eng" class="form-control " value="<?php echo($diksh_result->stavan1->sadhu_person_third_eng); ?>"  />
												...
												<div class="form-group">
													...
													<div class="inputer">
														...
														<div class="input-wrapper">
															...
															<input type="text" style="width: 200px" name="relation_third_hindi" class="form-control " value="<?php echo($diksh_result->stavan1->relation_third_hindi); ?>"  />
												...
												<div class="form-group">
													...
													<div class="inputer">
														...
														<div class="input-wrapper">
															...
															<input type="text" style="width: 200px" name="relation_third_eng" class="form-control " value="<?php echo($diksh_result->stavan1->relation_third_eng); ?>"  />
												...
												<div class="form-group">
													...
													<div class="inputer">
														...
														<div class="input-wrapper">
															...
															<input type="text" style="width: 200px" name="sadhu_person_fourth_hindi" class="form-control " value="<?php echo($diksh_result->stavan1->sadhu_person_fourth_hindi); ?>" />
												...
												<div class="form-group">
													...
													<div class="inputer">
														...
														<div class="input-wrapper">
															...
															<input type="text" style="width: 200px" name="sadhu_person_fourth_eng" class="form-control " value="<?php echo($diksh_result->stavan1->sadhu_person_fourth_eng); ?>" />
												...
												<div class="form-group">
													...
													<div class="inputer">
														...
														<div class="input-wrapper">
															...
															<input type="text" style="width: 200px" name="relation_fourth_hindi" class="form-control " value="<?php echo($diksh_result->stavan1->relation_fourth_hindi); ?>"/>
												...
												<div class="form-group">
													...
													<div class="inputer">
														...
														<div class="input-wrapper">
															...
															<input type="text" style="width: 200px" name="relation_fouth_eng" class="form-control " value="<?php echo($diksh_result->stavan1->relation_fouth_eng); ?>" />
												...
												<div class="form-group">
													...
													<div class="inputer">
														...
														<div class="input-wrapper">
															...
															<input type="text" style="width: 200px" name="sadhu_person_fifth_hindi" class="form-control " value="<?php echo($diksh_result->stavan1->sadhu_person_fifth_hindi); ?>" />
												...
												<div class="form-group">
													...
													<div class="inputer">
														...
														<div class="input-wrapper">
															...
															<input type="text" style="width: 200px" name="sadhu_person_fifth_eng" class="form-control " value="<?php echo($diksh_result->stavan1->sadhu_person_fifth_eng); ?>" />
												...
												<div class="form-group">
													...
													<div class="inputer">
														...
														<div class="input-wrapper">
															...
															<input type="text" style="width: 200px" name="relation_fifth_hindi" class="form-control " value="<?php echo$diksh_result->stavan1->relation_fifth_hindi; ?>" />
												...
												<div class="form-group">
													...
													<div class="inputer">
														...
														<div class="input-wrapper">
															...
															<input type="text" style="width: 200px" name="relation_fifth_eng" class="form-control " value="<?php echo($diksh_result->stavan1->relation_fifth_eng); ?>" />
												...
												<div class="form-group">
													...
													<div class="inputer">
														...
														<div class="input-wrapper">
															...
															<input type="text" style="width: 200px" name="user_name_hindi" class="form-control " value="<?php echo($diksh_result->stavan2->user_name_hindi); ?>"  />
												...
												<div class="form-group">
													...
													<div class="inputer">
														...
														<div class="input-wrapper">
															...
															<input type="text" style="width: 200px" name="user_name_eng" class="form-control " value="<?php echo($diksh_result->stavan2->user_name_eng); ?>" />
			...
			<input type="text" style="width: 200px" name="dob" class="form-control bootstrap-daterangepicker-basic" value="<?php echo date('m/d/Y',strtotime($diksh_result->stavan2->dob)); ?>" required />
														</div>
												...
												<div class="form-group">
													...
													<div class="inputer">
														...
														<div class="input-wrapper">
															...
															<input type="text" style="width: 200px" name="birth_place_hindi" class="form-control " value="<?php echo($diksh_result->stavan2->birth_place_hindi); ?>" />
												...
												<div class="form-group">
													...
													<div class="inputer">
														...
														<div class="input-wrapper">
															...
															<input type="text" style="width: 200px" name="birth_place_eng" class="form-control " value="<?php echo($diksh_result->stavan2->birth_place_eng); ?>"/>
												...
												<div class="form-group">
													...
													<div class="inputer">
														...
														<div class="input-wrapper">
															...
															<input type="text" style="width: 200px" name="father_name_hindi" class="form-control " value="<?php echo($diksh_result->stavan2->father_name_hindi); ?>" />
												...
												<div class="form-group">
													...
													<div class="inputer">
														...
														<div class="input-wrapper">
															...
															<input type="text" style="width: 200px" name="father_name_eng" class="form-control " value="<?php echo($diksh_result->stavan2->father_name_eng); ?>" />
												...
												<div class="form-group">
													...
													<div class="inputer">
														...
														<div class="input-wrapper">
															...
															<input type="text" style="width: 200px" name="gotra_hindi" class="form-control " value="<?php echo($diksh_result->stavan2->gotra_hindi); ?>"/>
												...
												<div class="form-group">
													...
													<div class="inputer">
														...
														<div class="input-wrapper">
															...
															<input type="text" style="width: 200px" name="gotra_eng" class="form-control " value="<?php echo($diksh_result->stavan2->gotra_eng); ?>" />
												...
												<div class="form-group">
													...
													<div class="inputer">
														...
														<div class="input-wrapper">
															...
															<input type="text" style="width: 200px" name="mother_name_hindi" class="form-control " value="<?php echo($diksh_result->stavan2->mother_name_hindi); ?>"/>
												...
												<div class="form-group">
													...
													<div class="inputer">
														...
														<div class="input-wrapper">
															...
															<input type="text" style="width: 200px" name="mother_name_eng" class="form-control " value="<?php echo($diksh_result->stavan2->mother_name_eng); ?>"/>
												...
												<div class="form-group">
													...
													<div class="inputer">
														...
														<div class="input-wrapper">
															...
															<input type="text" style="width: 200px" name="degree_eng" class="form-control " value="<?php echo($diksh_result->stavan3->degree_eng); ?>"/>
												...
												<div class="form-group">
													...
													<div class="inputer">
														...
														<div class="input-wrapper">
															...
															<input type="text" style="width: 200px" name="degree_hindi" class="form-control " value="<?php echo($diksh_result->stavan3->degree_hindi); ?>"/>
												...
												<div class="form-group">
													...
													<div class="inputer">
														...
														<div class="input-wrapper">
															...
															<input type="text" style="width: 200px" name="sadhana_place_eng" class="form-control " value="<?php echo($diksh_result->stavan3->sadhana_place_eng); ?>"/>
												...
												<div class="form-group">
													...
													<div class="inputer">
														...
														<div class="input-wrapper">
															...
															<input type="text" style="width: 200px" name="sadhana_place_hindi" class="form-control " value="<?php echo($diksh_result->stavan3->sadhana_place_hindi); ?>"/>
												...
												<div class="form-group">
													...
													<div class="inputer">
														...
														<div class="input-wrapper">
															...
															<input type="text" style="width: 200px" name="vihar_place_eng" class="form-control " value="<?php echo($diksh_result->stavan3->vihar_place_eng); ?>"/>
												...
												<div class="form-group">
													...
													<div class="inputer">
														...
														<div class="input-wrapper">
															...
															<input type="text" style="width: 200px" name="vihar_place_hindi" class="form-control " value="<?php echo($diksh_result->stavan3->vihar_place_hindi); ?>"/>
												...
												<div class="form-group">
													...
													<div class="inputer">
														...
														<div class="input-wrapper">
															...
															<input type="text" style="width: 200px" name="chaturmars_vivran_eng" class="form-control " value="<?php echo($diksh_result->stavan3->chaturmars_vivran_eng); ?>"/>
												...
												<div class="form-group">
													...
													<div class="inputer">
														...
														<div class="input-wrapper">
															...
															<input type="text" style="width: 200px" name="chaturmars_vivran_hindi" class="form-control " value="<?php echo($diksh_result->stavan3->chaturmars_vivran_hindi); ?>"/>
												...
												<div class="form-group">
													...
													<div class="inputer">
														...
														<div class="input-wrapper">
															...
															<input type="text" style="width: 200px" name="aagam_gyan_eng" class="form-control " value="<?php echo($diksh_result->stavan3->aagam_gyan_eng); ?>"/>
												...
												<div class="form-group">
													...
													<div class="inputer">
														...
														<div class="input-wrapper">
															...
															<input type="text" style="width: 200px" name="aagam_gyan_hindi" class="form-control " value="<?php echo($diksh_result->stavan3->aagam_gyan_hindi); ?>"/>
												...
												<div class="form-group">
													...
													<div class="inputer">
														...
														<div class="input-wrapper">
															...
															<input type="text" style="width: 200px" name="tatv_gyan_eng" class="form-control " value="<?php echo($diksh_result->stavan3->tatv_gyan_eng); ?>"/>
												...
												<div class="form-group">
													...
													<div class="inputer">
														...
														<div class="input-wrapper">
															...
															<input type="text" style="width: 200px" name="tatv_gyan_hindi" class="form-control " value="<?php echo($diksh_result->stavan3->tatv_gyan_hindi); ?>"/>
												...
												<div class="form-group">
													...
													<div class="inputer">
														...
														<div class="input-wrapper">
															...
															<input type="text" style="width: 200px" name="tap_vivran_eng" class="form-control " value="<?php echo($diksh_result->stavan3->tap_vivran_eng); ?>"/>
												...
												<div class="form-group">
													...
													<div class="inputer">
														...
														<div class="input-wrapper">
															...
															<input type="text" style="width: 200px" name="tap_vivran_hindi" class="form-control " value="<?php echo($diksh_result->stavan3->degree_eng); ?>"/>
												...
												<div class="form-group">
													...
													<div class="inputer">
														...
														<div class="input-wrapper">
															...
															<input type="text" style="width: 200px" name="language_gyan_eng" class="form-control " value="<?php echo($diksh_result->stavan3->language_gyan_eng); ?>"/>
												...
												<div class="form-group">
													...
													<div class="inputer">
														...
														<div class="input-wrapper">
															...
															<input type="text" style="width: 200px" name="pratistha_vivran_eng" class="form-control " value="<?php echo($diksh_result->stavan3->pratistha_vivran_eng); ?>"/>
												...
												<div class="form-group">
													...
													<div class="inputer">
														...
														<div class="input-wrapper">
															...
															<input type="text" style="width: 200px" name="language_gyan_hindi" class="form-control " value="<?php echo($diksh_result->stavan3->language_gyan_hindi); ?>"/>
												...
												<div class="form-group">
													...
													<div class="inputer">
														...
														<div class="input-wrapper">
															...
															<input type="text" style="width: 200px" name="pratistha_vivran_hindi" class="form-control " value="<?php echo($diksh_result->stavan3->pratistha_vivran_hindi); ?>"/>
												...
												<div class="form-group">
													...
													<div class="inputer">
														...
														<div class="input-wrapper">
															...
															<input type="text" style="width: 200px" name="diksha_sadhu_hindi" class="form-control " value="<?php echo($diksh_result->stavan3->language_gyan_hindi); ?>"/>
												...
												<div class="form-group">
													...
													<div class="inputer">
														...
														<div class="input-wrapper">
															...
															<input type="text" style="width: 200px" name="diksha_sadhu_eng" class="form-control " value="<?php echo($diksh_result->stavan3->language_gyan_hindi); ?>"/>
												...
												<div class="col-md-6">
													...
													<div class="form-group">
														...
														<div class="pull-right">
																...
																<button type="submit" name="add_note_submit" value="1" class="btn btn-blue">update</button>
                                                                      <a href="users.php?user_type=all" class="btn btn-flat btn-default">Cancel</a>
