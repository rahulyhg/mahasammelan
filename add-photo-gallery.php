...
if(empty($_SESSION['gallery_id'])){
	//echo $_SESSION['gallery_id']."rrr<br>";
		...
		<div class="col-md-12">
			<div class="panel">
				<div class="panel-heading">
					<div class="panel-title"><h4>Add Photo Gallery</h4></div>
				</div><!--.panel-heading-->
							...
							<div class="form-actions">
								<div class="row">
									<div class="col-md-offset-3 col-md-9">
										<button type="submit" name="add_photo_gallery_submit" value="1" form="Form1"  class="btn btn-primary">Submit</button>
