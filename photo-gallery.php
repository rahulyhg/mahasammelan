...
$result = $Obj->httpGet(ADMIN_URL.'api/gallery');
							...
							<tbody>
								...
								<tr>
									...
									<td>
										...
										<a class="" href="edit-photo-gallery.php?id=<?php echo $Obj->encrypt($gallery_value->id); ?>">Edit</a>

										<a class="" href="#" onclick="deleteData('<?php echo $gallery_value->id; ?>','gallery','id','photo-gallery.php')">Delete</a>
