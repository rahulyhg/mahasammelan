...
if($_FILES["photo"]["name"]!="" && !empty($_FILES["photo"]["name"])){
	...
	$result = $Obj->httpPost(ADMIN_URL.'api/religiousplaces/add',array('name'=>trim($_POST['dadawadi_name']),
	'name_hindi'=> trim($_POST['dadawadi_name_hindi']),
	'description'=>trim($_POST['dadawadi_description']),
	'address'=>trim($_POST['dadawadi_address']),'image'=>$profile_photo,
	'type'=>'dadawadi','state_id'=>$_POST['state_id'],
				...
				<div class="panel">
					...
					<div class="panel-heading">
						...
						<ul class="nav nav-tabs with-panel">
							...
							<li class="active"><a href="#panel-tab1" data-toggle="tab" class="btn-ripple">Add Dadwadi</a></li>
							...
							<div class="form-body">
									...
									<div class="col-md-5">
										<div class="inputer">
											<div class="input-wrapper">
												<input type="text" name="dadawadi_name" class="form-control" value=""  required>
											</div>
										</div>
									</div>
									</div>
								...
								<div class="form-group">
									...
									<div class="col-md-5">
										<div class="inputer">
											<div class="input-wrapper">
												<input type="text" name="dadawadi_name_hindi" class="form-control" value=""  required>
											</div>
										</div>
									</div>
									</div>
								 ...
								 <div class="form-group">
									...
									<div class="col-md-5">
										<div class="inputer">
											<div class="input-wrapper">
												<textarea name="dadawadi_address" class="form-control" required></textarea>
											</div>
										</div>
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-md-5">
										<div class="inputer">
											<div class="input-wrapper">
												<textarea name="dadawadi_address_hindi" class="form-control" required></textarea>
											</div>
										</div>
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-md-5">
										<div class="inputer">
											<div class="input-wrapper">
												<textarea name="dadawadi_description" class="form-control" required></textarea>
											</div>
										</div>
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-md-5">
										<div class="inputer">
											<div class="input-wrapper">
												<textarea name="dadawadi_description_hindi" class="form-control" required></textarea>
											</div>
										</div>
									</div>
								</div>
