...
$error_msg = '';
if(isset($_POST['add_slider_submit']) && !empty($_POST['add_slider_submit'])){
	
	$sourcePath = $_FILES['image']['tmp_name'];
	$image = time().'-'.$_FILES['image']['name'];
	$targetPath = "../".SLIDER_IMAGES.$image;
	...
	$result = $Obj->httpPost(BASE_URL.'api/slider/add',array('content'=>trim($_POST['content']),'title'=>trim($_POST['title']), 'image'=> $image));
	$Obj->Redirect("sliders.php");
	exit;
}
		...
		<div class="col-md-12">
			<div class="panel">
				<div class="panel-heading">
					<div class="panel-title"><h4>Add Slider</h4></div>
				</div><!--.panel-heading-->
				...
				<?php } ?>
					<div class="row">
						<form action="" id="add_slider_submit" class="form-horizontal parsley-validate parsley-validate-icon" method="post" enctype="multipart/form-data">
							<div class="form-body">
									...
									<div class="col-md-5">
										<div class="inputer">
											<div class="input-wrapper">
												<input type="text" name="title" class="form-control" value="<?php echo $slider_result->slider_array->title; ?>"  required>
											</div>
										</div>
									</div>
								</div>
								...
								<div class="form-group">
										...
										<div class="col-md-9">
											<textarea class="form-control summernote-default" id="content" name="content" required><?php echo $slider_result->slider_array->content; ?></textarea>
										</div>
									</div>
											...
											<div class="col-md-9">
												...
												<div class="fileinput fileinput-new" data-provides="fileinput">
													<div class="fileinput-preview thumbnail" data-trigger="fileinput" style="width: 200px; height: 150px;">
															<!--<img  src="http://www.unserialize.com/images/logo.png">-->
													</div>
													<div>
							...
							<div class="form-actions">
								<div class="row">
									<div class="col-md-offset-3 col-md-9">
										<button type="submit" name="add_slider_submit" value="1"  class="btn btn-primary">Submit</button>
										<a href="sliders.php" class="btn btn-flat btn-default">Cancel</a>
